...
import com.amdocs.plant.dao.DBConnection;
	...
	public static void main(String args[]) {
		...
		do {
			...
			case 1:
			{
				...
				Plant newPlant = new Plant(0, null, null, 0, null, null, 0);
				System.out.print("\nPlantID: ");
			...
			case 5:
			{
				...
				ArrayList<Plant> plantResult = new ArrayList<Plant>();
				plantResult = PlantDAO.searchByOriginCountryName(countryName);
			...
			{
				ArrayList<Plant> plantResult = new ArrayList<Plant>();
				plantResult = PlantDAO.searchOutdoorPlantsWithSunlight();
